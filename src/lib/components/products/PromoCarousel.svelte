<section class="relative overflow-hidden rounded-lg bg-slate-100 shadow-sm">
		...
		>
			...
			<div class="h-24 w-24 shrink-0 overflow-hidden rounded-lg border border-white/10 shadow-lg">
				<img
					...
					src="https://lh3.googleusercontent.com/aida-public/AB6AXuCIbO56WyDZcCAE451xfAbKr9NwUkd2-udfqOSxOtpdKDyW6fRIw2QvwhiGl0lzf48SWxlzWw042OnBUAv9FvaeIzpaWWB3h1AkFw9OKPOJ1VtswB5bG9hxG6teUObN7nR-NSAsFzBdGIjUpcMo4wPZ73J5FqXd-FpIjNaj-FOUqPIOevgholIPDjUvaOExnCoJAgEsEfPXmzPxVZJxb8zjtsLOOKXtOm9j38odxzHRCdFVwEfKeyHfkehoozmqxNEG5xuVtHmwiek"
				/>
			</div>
		</div>
	</div>
